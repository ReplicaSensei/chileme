    ...
    <ul class="nav sidebar-nav">
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/chileme/seller/product/list">列表</a></li>
                <li><a href="/chileme/seller/product/index">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/chileme/seller/category/list">列表</a></li>
                <li><a href="/chileme/seller/category/index">新增</a></li>
            </ul>
        </li>
